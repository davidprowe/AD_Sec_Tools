...
#============================
 ...
 $AttributestoLookup = @('Randomattributetocheck','gecos')
...
$group = Get-ADgroup 'uis-seas-admin'
$sid = new-object System.Security.Principal.SecurityIdentifier $group.SID


#Domain and OU at which to grant access

$ou = 'OU=Testing,DC=dev,DC=domainname,DC=com'
$ou = Get-ADOrganizationalUnit $ou
$acl = Get-ACL ($ou)
<#
$drive = "P0ad"
$ou = 'DC=production,DC=domain,DC=com'
#>
